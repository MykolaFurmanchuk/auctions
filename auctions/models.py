...
class User(AbstractUser):
    phone_number = models.CharField(blank=True,max_length=13,verbose_name='phone_number',default=' ')
...
class Listing(models.Model):
    ...
    date_closed = models.DateField(default=datetime.date.today() + datetime.timedelta(days=1))
